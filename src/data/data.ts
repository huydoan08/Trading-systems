...
export const commonMistake = [
  "Sai lầm nghiêm trọng vào lệnh với khối lượng lớn.",
  "Hay mở tài khoản ra xem các khoản lời lỗ rồi bị áp lực tâm lý.",
  "Lỗi thấy giá mới di chuyển ngược xu hướng một chút đã vội vàng đóng lệnh bằng tay.",
  "Lỗi vội vàng chốt lời non khi giá vừa mới chạy.",
  ...
  "Lỗi cố tình đi đoán đỉnh đoán đáy."
];
...
export const faqs = [
  ...
  {
    title:
      "2. Vùng tích luỹ lực mua, vùng tích luỹ lực bán là gì, làm thế nào để xác định được nó ?",
    content: [
