...
export const faqs = [
  ...
  {
    title:
      "2.Khi nhìn thấy dấu hiệu phân kì giảm thì có nên bay vào Short liền hay không?",
    content: [
      "Không nên, nếu có ý định Short thì cần phải quan sát xu hướng của khung lớn hơn, và xem lực mua ở khung nhỏ hơn. Khi ấy có thể treo lệnh chờ để chờ đợi cơ hội."
    ]
  },
  {
    title:
  ...
  {
    title: "5.Có nên giao dịch future hay không?",
    content: [
  ...
  {
    title: "6.Có nên đánh Altcoin hay không?",
    content: [
  ...
  {
    title:
      "7.Khi nhìn thấy dấu hiệu khung H1 đã đi xa và suy yếu thì có vội vàng thoát lệnh mua hay không?",
    content: [
      "Không nên, cần quan sát khung giao dịch xem sóng đã đi xa hay chưa, hiện đang là sóng mấy, quan sát thêm các dấu hiệu Price action, fibo có giữ cấu trúc tăng tiếp hay không, cách tốt nhất là nên quản lý lệnh theo systems và thoát lệnh khi đã đạt ra target trước đó.."
    ]
  }
];
