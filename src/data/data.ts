...
export const allData: YearlyData = {
  ...
  "2025": [
    ...
    { name: "03/2025", revenue: -40 },
    { name: "04/2025", revenue: 0 }
  ]
};
...
export const faqs = [
  {
    ...
    content: [
      "Tức là giá thì tăng mà RSI thì tạo đỉnh thấp dần ( giải thích điều này là khi mà giá tăng mạnh nhưng mà lúc này RSI đi xuống tạo đỉnh thấp dần, chứng tỏ lực mua đã suy yếu, lực bán đã tham gia vào nhiều, thì cần lập tức bỏ chạy.\n\nLưu ý:\n Có dấu hiệu phân kì cũng chưa chắc là giá đã giảm, mà giá nó có thể giảm xíu xong nó tăng tiếp rất mạnh.\n Việc của mình là thấy có dấu hiệu phân kì thì mình biết rằng giá có khả năng điều chỉnh, còn điều chỉnh xong nó có tăng tiếp hay không thì câu chuyện đó tính sau.\nNếu thấy RSI điều chỉnh xong và đo fibo thấy vẫn giữ giá tốt thì lại tiếp tục tham gia mua vào.",
    ]
  },
  {
    title: "2. Vùng tích luỹ lực mua, vùng tích luỹ lực bán là gì, làm thế nào để xác định được nó ?",
    content: [
...
export const storyTelling =
  [
    ...
    {
      title: "Quán Cà Phê Và Câu Chuyện Của Một Trader",
      "content": [
        "Tại một quán cà phê nhỏ, có một người đàn ông trung niên với vẻ mặt u sầu đang ngồi một mình. Ông ta là một trader đã thua lỗ rất nhiều tiền trong thị trường forex.\nCảm thấy chán nản và tuyệt vọng, ông ta quyết định tìm đến quán cà phê quen thuộc để tìm chút bình yên.\n\nTrong lúc ông ta đang suy nghĩ về những sai lầm của mình, một chàng trai trẻ tuổi mặc áo thun trắng bước vào quán. Chàng trai có vẻ ngoài tươi tắn và tràn đầy năng lượng. Anh ta gọi một ly cà phê và ngồi xuống bàn bên cạnh người đàn ông.\n\nHai người bắt đầu trò chuyện. Người đàn ông kể cho chàng trai nghe về những thất bại của mình trong thị trường forex. Chàng trai lắng nghe một cách chăm chú và không đưa ra bất kỳ lời phán xét nào.\n\nSau khi nghe xong câu chuyện của người đàn ông, chàng trai mỉm cười và nói: \"Tôi hiểu cảm giác của anh. Tôi cũng đã từng thua lỗ rất nhiều tiền khi mới bắt đầu tham gia vào thị trường forex.\"\n\nNgười đàn ông ngạc nhiên hỏi: \"Vậy làm sao anh có thể vượt qua được những khó khăn đó?\"\n\nChàng trai trả lời: \"Tôi đã học được một điều quan trọng rằng bản chất của thị trường là sự bất định, không chắc chắn. Không có lệnh nào được đảm bảo thắng cả.\"\n\nNgười đàn ông suy nghĩ một lúc rồi nói: \"Ý của anh là gì?\"\n\nChàng trai giải thích: \"Thị trường luôn biến động và thay đổi. Không ai có thể dự đoán được chính xác điều gì sẽ xảy ra trong tương lai. Vì vậy, chúng ta không nên quá tự tin vào khả năng của mình và đặt cược tất cả vào một lệnh duy nhất.\"\n\nNgười đàn ông gật gù hiểu ra. Ông ta nói: \"Vậy theo anh, chúng ta nên làm gì để thành công trong thị trường forex?\"\n\nChàng trai trả lời: \"Chúng ta cần phải chấp nhận sự không chắc chắn của thị trường và học cách quản lý rủi ro. Và quan trọng nhất là phải luôn giữ cho mình một tâm lý bình tĩnh và kiên nhẫn.\"\n\nNgười đàn ông cảm ơn chàng trai vì những lời khuyên quý giá. Ông ta cảm thấy như mình đã tìm lại được hy vọng sau những ngày tháng đen tối.\n\nKể từ đó, người đàn ông bắt đầu thay đổi cách tiếp cận của mình đối với thị trường forex. Ông ta học cách quản lý rủi ro tốt hơn và không còn đặt cược tất cả vào một lệnh duy nhất. Nhờ đó, ông ta dần dần lấy lại được những gì đã mất và trở thành một nhà đầu tư thành công.\n\n———\n\nBạn đã từng có một vài lệnh mong muốn thay đổi cuộc đời cho đến khi tài khoản của bạn bốc cháy? Hãy thực sự dành thời gian suy nghĩ về câu chuyện này, nếu bạn hiểu ra...thì một chương mới trong hành trình giao dịch của bạn sẽ hé mở cánh cửa mang lại kết quả tuyệt vời."
      ]
    }
  ]
