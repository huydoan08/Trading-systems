...
const PTKT = [
  {
    ...
    content: [
      ...
      "Khung H4 => RSI tăng và đang mở rộng, mới chạm vùng 70 đã có dấu hiệu điều chỉnh, lực tăng chưa thực sự mạnh mẽ.",
      "Khung H1 => RSI tăng, chưa chạm vùng 80 thì có dấu hiệu điều chỉnh, lực tăng không thực sự mạnh mẽ, cần chú ý quan sát tiếp.",
      "CHIẾN LƯỢC NGẮN HẠN => LƯỚT SÓNG NGẮN H4, QUẢN LÝ LỆNH TẠI VÙNG 82K.",
