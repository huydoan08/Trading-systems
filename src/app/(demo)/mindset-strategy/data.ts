export const mindsetAndStrategy = [
  ...
  "Khi mà BTC được bơm lên rất mạnh ( uptrend ) thì hãy canh tìm một số đồng coin lowcap chưa được bơm để lướt sóng ngắn",
  "Khi mà một đồng coin có RSI vượt ra ngoài vùng 80, thì có thể canh con sóng điều chỉnh để bắt con sóng hồi",
  "Tương tự khi mà một đồng coin có RSI vượt xuống dưới vùng 20, thì có thể canh con sóng điều chỉnh để bắt con sóng hồi"
];
