...
export const BotHunter = [
  ...
  "buylimit T atP V USDT tp20% sl-2%",
  "buylimit T atP V USDT tp20%",
  "buystop T atP V USDT tpP slP",
  "buystop T atP V USDT tpP",
  "buystop T atP V USDT tp20% sl-2%",
  "buystop T atP V USDT tp20%",
  "sell V T atP USDT 1buy-30% 2buy10%",
  "sell V T atP USDT 1buyP 2buyP",
  "sell V T atP USDT allbuy-30%",
  "sell V T atP USDT allbuyP",
  "sell V T atP USDT onlybuy-30%",
  "sell V T atP USDT onlybuyP",
  "sell V T USDT tpP slP",
  "sell V T USDT tp20% sl-10%",
  "sellstop V T P USDT",
  "sellstop V T -10% USDT",
  "sellstop V T P USDT buy P",
  "del T",
  "del sell T",
  "del buy T",
  "del sell P TUSDT",
